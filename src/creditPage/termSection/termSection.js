    ...
    return(
        <div className="term">
            ...
            <div className="termCartsCont mx-nol-0 row justify-content-nol-center container-fluid">
                <div className="col-sm-12 col-md-3 col-lg-3 col-xl-3 mx-sm-2 mx-md-2 mx-xl-3 my-nol-2 my-md-0 simple termCarts">
                    <h1>Simple</h1>
                ...
                <div className="col-sm-12 col-md-3 col-lg-3 col-xl-3 mx-sm-2  mx-md-2 mx-xl-3 my-nol-2 my-md-0 silver termCarts">
                    <h1>Silver</h1>
                ...
                <div className="col-sm-12 col-md-3 col-lg-3 col-xl-3 mx-sm-2  mx-md-2 mx-xl-3 my-nol-2 my-md-0 gold termCarts"> 
                    <h1>Gold</h1>
                ...
                <div className="col-sm-12 col-md-3 col-lg-3 col-xl-3 mx-sm-2  mx-sm-0 my-nol-2 my-md-0 mx-md-2 mx-xl-3   platinum termCarts">
                    <h1>Platinum</h1>
